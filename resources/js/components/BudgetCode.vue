        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h3 class="page-title">{{ 'Budget Codes' | translateIn(this.locale)}}</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">{{ 'dashboard' | translateIn(this.locale) }}</a></li>
                        <li class="breadcrumb-item active">{{ 'budget codes' | translateIn(this.locale) }}</li>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-striped custom-table" id="receipt_transactions">
                        ...
                        <tbody>
                            <tr v-for="budgetcode in budgetcodes.data" :key="budgetcode.id">
                                <td>{{budgetcode.id}}</td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#" @click="edit_modal(budgetcode)"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                            <a class="dropdown-item" href="#" @click="delete_budgetcodes(budgetcode.id)"><i class="fa fa-trash m-r-5"></i> Delete</a>                                                
                                        </div>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <pagination :data="budgetcodes" @pagination-change-page="getResults">
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="edit_mode ? update_budgetcode() : create_budgetcode()" >
                            <div class="row">
                                <div class="col-sm-12">
    ...
    export default {
        ...
        methods: {
            ...
            search_it() {
                ...
                axios.get('search_budgetcode?q=' + query)
                .then((data) => {
            ...
            getResults(page = 1) {
                ...
                axios.get('get_budgetcode/?page=' + page)
                    .then(response => {
                        this.$Progress.start();
            ...
            edit_modal(budgetcode) {
                this.edit_mode = true;
                this.form.reset();
                $('#add_project').modal('show');
                this.form.fill(budgetcode);
            },

            //this method goes to customer.store and store customer data
            create_budgetcode() {
                 this.form.post('budgetcode')
                .then((res)=>{
                    ...
                    if(this.locale == "en")
                    {
                        toast.fire({
                        icon: 'success',
                        title: 'Budget Code created successfully'
                        });
                    }
            ...
            update_budgetcode() 
            {
                this.form.put('budgetcode/'+this.form.id)
                .then((res)=>{
                    ...
                    if(this.locale == "en")
                    {
                        toast.fire({
                        icon: 'success',
                        title: 'Budget Code updated successfully'
                        });
                    }
                    else if(this.locale == "fa")
                    {
            ...
            load_budgetcodes() {
                axios.get('get_budgetcode').then(({data}) => (this.budgetcodes = data));
              
            },

            delete_budgetcodes(id) {
                if(this.locale == "en")
                {
                    swal.fire({
                    title: 'Are you sure?',
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.isConfirmed) {
                            ...
                            this.form.delete('budgetcode/'+id).then(()=>{
                                swal.fire(
                                'Deleted!',
