        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h3 class="page-title">{{ 'Budget Allocations' | translateIn(this.locale)}}</h3>
                    <ul class="breadcrumb">
                        ...
                        <form @submit.prevent="edit_mode ? update_allocation() : create_allocation()" >
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="form.project_id" name="project" title="project" data-live-search="false" >
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            axios.get('get_allocation').then(({data}) => this.allocations = data)
        },
